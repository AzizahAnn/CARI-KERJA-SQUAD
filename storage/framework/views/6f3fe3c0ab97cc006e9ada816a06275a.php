...
<body>
    ...
    <div class="container">
        ...
        <h2 style="margin-bottom: 1.5rem; color: #31487A;">Daftar Perusahaan (<?php echo e($perusahaan->count()); ?>)</h2>

        <?php if($perusahaan->count() > 0): ?>
        <table>
            <thead>
                <tr>
                    <th>No</th>
            ...
            <tbody>
                <?php $__currentLoopData = $perusahaan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <td>
                        <span class="badge badge-<?php echo e($item->status_verifikasi); ?>">
                            <?php echo e(ucfirst($item->status_verifikasi)); ?>

                        </span>
                    </td>
                    <td>
                        <?php if($item->status_verifikasi == 'menunggu'): ?>
                        <form action="<?php echo e(route('admin.perusahaan.setujui', $item->id)); ?>" method="POST" style="display:inline;">
                            <?php echo csrf_field(); ?>
                            <button type="submit" class="btn btn-success"><i class="fa-solid fa-check"></i> Setujui</button>
                        </form>
                        <form action="<?php echo e(route('admin.perusahaan.tolak', $item->id)); ?>" method="POST" style="display:inline;" onsubmit="return confirm('Yakin tolak perusahaan ini?')">
                            <?php echo csrf_field(); ?>
...
</html><?php /**PATH D:\MYLARAVEL\project_saya\resources\views/admin/perusahaan/index.blade.php ENDPATH**/ ?>