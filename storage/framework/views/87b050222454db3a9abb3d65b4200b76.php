...
<body>
    ...
    <div class="container">
        <a href="<?php echo e(route('mahasiswa.lowongan.index')); ?>" class="back-link"><i class="fa-solid fa-arrow-left"></i> Kembali ke Daftar Lowongan</a>
        ...
        <div class="alert alert-error"><i class="fa-solid fa-times-circle"></i> <?php echo e(session('error')); ?></div>
        <?php endif; ?>

        <?php if($sudahDaftar): ?>
        <div class="alert alert-info">
            <i class="fa-solid fa-info-circle"></i> Anda sudah mendaftar di lowongan ini. Cek status di <a href="<?php echo e(route('mahasiswa.lamaran.index')); ?>">Riwayat Lamaran</a>
        </div>
        <?php endif; ?>
        ...
        <div class="card">
            <div class="header">
                <div>
                    ...
                    <p class="company"><i class="fa-solid fa-building"></i> <?php echo e($lowongan->perusahaan->nama_perusahaan); ?></p>
                </div>
                <span class="badge badge-<?php echo e($lowongan->tipe); ?>"><i class="fa-solid fa-tag"></i> <?php echo e(ucfirst($lowongan->tipe)); ?></span>
            </div>
        ...
        <div class="card">
            <div class="upload-section">
                ...
                <form action="<?php echo e(route('mahasiswa.lowongan.daftar', $lowongan->id)); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
</html><?php /**PATH D:\MYLARAVEL\project_saya\resources\views/mahasiswa/lowongan/detail.blade.php ENDPATH**/ ?>