...
<body>
    ...
    <div class="container">
        <a href="<?php echo e(route('admin.lowongan.index')); ?>" class="back-link">
        ...
        <div class="card">
            <div class="header">
                ...
                <span class="badge badge-<?php echo e($lowongan->status); ?>"><?php echo e(ucfirst($lowongan->status)); ?></span>
            </div>
            ...
            <div class="info-grid">
                ...
                <div class="info-item">
                    ...
                    <div class="info-value"><?php echo e($lowongan->created_at->format('d M Y H:i')); ?></div>
                </div>
            </div>
            ...
            <?php if($lowongan->status == 'menunggu'): ?>
            <div style="margin-top: 2rem;">
                <form action="<?php echo e(route('admin.lowongan.setujui', $lowongan->id)); ?>" method="POST" style="display:inline;">
                    <?php echo csrf_field(); ?>
                    <button type="submit" class="btn btn-success"><i class="fa-solid fa-check"></i> Setujui Lowongan</button>
                </form>
                <form action="<?php echo e(route('admin.lowongan.tolak', $lowongan->id)); ?>" method="POST" style="display:inline;" onsubmit="return confirm('Yakin tolak lowongan ini?')">
                    <?php echo csrf_field(); ?>
...
</html><?php /**PATH D:\MYLARAVEL\project_saya\resources\views/admin/lowongan/detail.blade.php ENDPATH**/ ?>