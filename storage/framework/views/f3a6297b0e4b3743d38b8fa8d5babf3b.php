...
<body>
    <nav class="navbar">
        ...
        <div class="user-info">
            ...
            <form action="<?php echo e(route('perusahaan.keluar')); ?>" method="POST" style="display: inline;">
                <?php echo csrf_field(); ?>
    ...
    <div class="container">
        ...
        <div class="alert alert-warning">
            <i class="fa-solid fa-exclamation-triangle"></i> <?php echo e(session('warning')); ?>

        </div>
        <?php endif; ?>

        <div class="welcome-card">
            <h2>Selamat Datang, **<?php echo e(auth()->user()->perusahaan->nama_perusahaan); ?>**!</h2>
            <p>Kelola lowongan dan lihat pelamar dari sini.</p>
            
            <?php if(auth()->user()->perusahaan->status_verifikasi === 'menunggu'): ?>
            <span class="status-badge status-menunggu"><i class="fa-solid fa-hourglass-half"></i> Menunggu Verifikasi Admin</span>
            <?php elseif(auth()->user()->perusahaan->status_verifikasi === 'disetujui'): ?>
        ...
        <div class="menu-list">
            ...
            <a href="<?php echo e(route('perusahaan.lowongan.buat')); ?>" class="menu-item"><i class="fa-solid fa-plus-circle"></i> Buat Lowongan Baru</a>
            <a href="<?php echo e(route('perusahaan.lowongan.index')); ?>" class="menu-item"><i class="fa-solid fa-list-check"></i> Kelola Lowongan Saya</a>
        </div>
    </div>
</body>
</html><?php /**PATH D:\MYLARAVEL\project_saya\resources\views/perusahaan/dashboard.blade.php ENDPATH**/ ?>