...
<body>
    <div class="login-container">
        ...
        <form action="<?php echo e(route('perusahaan.masuk')); ?>" method="POST">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="links">
            <a href="<?php echo e(route('perusahaan.daftar')); ?>"><strong>Belum punya akun? Daftar di sini</strong></a>
            <a href="<?php echo e(route('pilih.peran')); ?>"><i class="fa-solid fa-arrow-left"></i> Kembali ke Pilih Peran</a>
        </div>
    </div>
</body>
</html><?php /**PATH D:\MYLARAVEL\project_saya\resources\views/auth/masuk/perusahaan.blade.php ENDPATH**/ ?>