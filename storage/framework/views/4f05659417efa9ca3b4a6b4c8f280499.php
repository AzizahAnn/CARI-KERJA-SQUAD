...
<body>
    <nav class="navbar">
        ...
        <div>
            ...
            <a href="<?php echo e(route('mahasiswa.lowongan.index')); ?>"><i class="fa-solid fa-briefcase"></i> Cari Lowongan</a>
    ...
    <div class="container">
        <div class="search-box">
            <form action="<?php echo e(route('mahasiswa.lowongan.index')); ?>" method="GET" class="search-form">
                <input type="text" name="cari" placeholder="Cari posisi, perusahaan, atau lokasi..." value="<?php echo e(request('cari')); ?>">
                <select name="tipe">
                    <option value="">Semua Tipe</option>
                    <option value="magang" <?php echo e(request('tipe') == 'magang' ? 'selected' : ''); ?>>Magang</option>
                    <option value="kerja" <?php echo e(request('tipe') == 'kerja' ? 'selected' : ''); ?>>Kerja</option>
                </select>
                <button type="submit"><i class="fa-solid fa-search"></i> Cari</button>
            </form>
        </div>

        <h2 style="margin-bottom: 1.5rem; color: #192338;">Lowongan Tersedia (<?php echo e($lowongan->count()); ?>)</h2>
        ...
        <?php if($lowongan->count() > 0): ?>
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <span class="badge badge-<?php echo e($item->tipe); ?>"><i class="fa-solid fa-tag"></i> <?php echo e(ucfirst($item->tipe)); ?></span>
                </div>
                ...
                <p class="card-info"><i class="fa-solid fa-file-alt"></i> <?php echo e(Str::limit($item->deskripsi, 150)); ?></p>
                
                <a href="<?php echo e(route('mahasiswa.lowongan.detail', $item->id)); ?>" class="btn-detail"><i class="fa-solid fa-eye"></i> Lihat Detail & Lamar</a>
            </div>
...
</html><?php /**PATH D:\MYLARAVEL\project_saya\resources\views/mahasiswa/lowongan/index.blade.php ENDPATH**/ ?>