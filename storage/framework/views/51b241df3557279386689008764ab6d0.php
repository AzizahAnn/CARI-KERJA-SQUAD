    ...
    <div class="container">
        ...
        <div class="card-container">
            <div class="card admin">
                ...
                <a href="<?php echo e(route('admin.masuk')); ?>" class="btn">Masuk Admin</a>
            </div>
            ...
            <div class="card perusahaan">
                ...
                <a href="<?php echo e(route('perusahaan.masuk')); ?>" class="btn">Masuk Perusahaan</a>
                <br>
                <a href="<?php echo e(route('perusahaan.daftar')); ?>" class="link-daftar perusahaan-link">Belum punya akun? Daftar</a>
            </div>
            ...
            <div class="card mahasiswa">
                ...
                <a href="<?php echo e(route('mahasiswa.masuk')); ?>" class="btn">Masuk Mahasiswa</a>
                <br>
                <a href="<?php echo e(route('mahasiswa.daftar')); ?>" class="link-daftar mahasiswa-link">Belum punya akun? Daftar</a>
            </div>
        </div>
        
        <a href="<?php echo e(route('beranda')); ?>" class="back-btn"><i class="fa-solid fa-arrow-left"></i> Kembali ke Beranda</a>
    </div>
</body>
</html><?php /**PATH D:\MYLARAVEL\project_saya\resources\views/auth/pilih-peran.blade.php ENDPATH**/ ?>