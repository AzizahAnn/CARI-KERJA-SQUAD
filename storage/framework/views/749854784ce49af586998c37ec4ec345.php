...
<body>
    ...
    <div class="container">
        <div class="card">
            <form action="<?php echo e(route('perusahaan.lowongan.simpan')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                
                <div class="form-group">
                    <label for="posisi"><i class="fa-solid fa-user-tie"></i> Posisi <span>*</span></label>
                    <input type="text" name="posisi" id="posisi" value="<?php echo e(old('posisi')); ?>" placeholder="Contoh: Backend Developer" required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <select name="tipe" id="tipe" required>
                        ...
                        <option value="magang" <?php echo e(old('tipe') == 'magang' ? 'selected' : ''); ?>>Magang</option>
                        <option value="kerja" <?php echo e(old('tipe') == 'kerja' ? 'selected' : ''); ?>>Kerja</option>
                    </select>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="lokasi" id="lokasi" value="<?php echo e(old('lokasi')); ?>" placeholder="Contoh: Jakarta Selatan" required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <input type="date" name="batas_akhir" id="batas_akhir" value="<?php echo e(old('batas_akhir')); ?>" min="<?php echo e(date('Y-m-d', strtotime('+1 day'))); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <textarea name="deskripsi" id="deskripsi" placeholder="Jelaskan detail pekerjaan..." required><?php echo e(old('deskripsi')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <textarea name="persyaratan" id="persyaratan" placeholder="Tuliskan persyaratan yang dibutuhkan..." required><?php echo e(old('persyaratan')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="btn-group">
                    ...
                    <a href="<?php echo e(route('perusahaan.lowongan.index')); ?>" class="btn btn-secondary"><i class="fa-solid fa-times"></i> Batal</a>
                </div>
            </form>
        </div>
    </div>
</body>
</html><?php /**PATH D:\MYLARAVEL\project_saya\resources\views/perusahaan/lowongan/buat.blade.php ENDPATH**/ ?>