...
<body>
    ...
    <div class="container">
        <div class="card">
            <form action="<?php echo e(route('perusahaan.lowongan.perbarui', $lowongan->id)); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <?php echo method_field('PUT'); ?>
                
                <div class="form-group">
                    <label for="posisi"><i class="fa-solid fa-user-tie"></i> Posisi <span>*</span></label>
                    <input type="text" name="posisi" id="posisi" value="<?php echo e(old('posisi', $lowongan->posisi)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <select name="tipe" id="tipe" required>
                        ...
                        <option value="magang" <?php echo e(old('tipe', $lowongan->tipe) == 'magang' ? 'selected' : ''); ?>>Magang</option>
                        <option value="kerja" <?php echo e(old('tipe', $lowongan->tipe) == 'kerja' ? 'selected' : ''); ?>>Kerja</option>
                    </select>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="lokasi" id="lokasi" value="<?php echo e(old('lokasi', $lowongan->lokasi)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <input type="date" name="batas_akhir" id="batas_akhir" value="<?php echo e(old('batas_akhir', $lowongan->batas_akhir->format('Y-m-d'))); ?>" min="<?php echo e(date('Y-m-d', strtotime('+1 day'))); ?>" required>
                    <?php $__errorArgs = ['batas_akhir'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><div class="error-text"><?php echo e($message); ?></div><?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <textarea name="deskripsi" id="deskripsi" required><?php echo e(old('deskripsi', $lowongan->deskripsi)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <textarea name="persyaratan" id="persyaratan" required><?php echo e(old('persyaratan', $lowongan->persyaratan)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="btn-group">
                    ...
                    <a href="<?php echo e(route('perusahaan.lowongan.detail', $lowongan->id)); ?>" class="btn btn-secondary"><i class="fa-solid fa-times"></i> Batal</a>
                </div>
            </form>
        </div>
    </div>
</body>
</html><?php /**PATH D:\MYLARAVEL\project_saya\resources\views/perusahaan/lowongan/ubah.blade.php ENDPATH**/ ?>