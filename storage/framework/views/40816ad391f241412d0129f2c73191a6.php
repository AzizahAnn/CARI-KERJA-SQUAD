    ...
    <div class="container">
        ...
        <div class="card">
            ...
            <table>
                ...
                <tbody>
                    <?php $__currentLoopData = $rekapStatus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td>
                            <span class="badge badge-<?php echo e($item->status); ?>"><?php echo e(ucfirst($item->status)); ?></span>
                        </td>
                        <td><?php echo e($item->jumlah); ?></td>
                        <td><?php echo e($totalPendaftaran > 0 ? round(($item->jumlah / $totalPendaftaran) * 100, 1) : 0); ?>%</td>
                    </tr>
        ...
        <div class="card">
            ...
            <table>
                ...
                <tbody>
                    <?php $__currentLoopData = $lowonganDenganPelamar; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td><?php echo e($index + 1); ?></td>
                        <td><?php echo e($item->posisi); ?></td>
                        <td><?php echo e($item->perusahaan->nama_perusahaan); ?></td>
                        <td><strong><?php echo e($item->pendaftaran_count); ?> orang</strong></td>
                        <td>
                            <span class="badge badge-<?php echo e($item->status); ?>"><?php echo e(ucfirst($item->status)); ?></span>
                        </td>
                    </tr>
...
</html><?php /**PATH D:\MYLARAVEL\project_saya\resources\views/admin/laporan/rekap.blade.php ENDPATH**/ ?>